...
installdependency(){
  ...
  if [[ $dist = centos ]]; then
    ...
    apt-get install sudo curl socat xz-utils wget apt-transport-https gnupg gnupg2 dnsutils lsb-release python3-qrcode python-pil unzip resolvconf ntpdate systemd -qq -y
 else
  clear
