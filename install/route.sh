...
routes=(AS4134 AS4837 AS9808 AS4538 AS4809 AS9929 AS2914 AS2497 AS2516 AS4725 AS9269 AS4635 AS4760 AS4637 AS58453 AS64050 AS6939 AS174 AS3257 AS7018)
routes_name=(163 169 CMNET CERNET CN2 CU-VIP NTT IIJ KDDI SoftBank HKBN HKIX HKT Telstra CMI BGPNET HE Cogent GTT ATT)
