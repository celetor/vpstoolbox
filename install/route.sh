...
routes=(AS4134 AS4837 AS4809 AS9929 AS2914 AS2497 AS2516 AS4725 AS9269 AS4635 AS4760 AS4637 AS58453)
routes_name=(163 169 CN2 CU-VIP NTT IIJ KDDI SoftBank HKBN HKIX HKT Telstra CMI)
...
route_final=$(cat route.txt | sort | uniq)
